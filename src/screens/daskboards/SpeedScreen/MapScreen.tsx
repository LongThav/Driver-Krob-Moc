  ...
  return (
    <View style={styles.container}>
      ...
      <View style = {styles.circleLocation}>
        <MaterialIcons name='my-location' color={ColorApp.cardColor} size={25}/>
      </View>
      <View style={styles.Bottom}>
        <LinearGradient
          ...
          <AntDesign color={'white'} size={20} name="right" style = {{opacity: 0.8}}/>
          <AntDesign color={'white'} size={20} name="right" style = {{opacity: 0.5}}/>
          <AntDesign color={'white'} size={20} name="right"  style = {{opacity: 0.2}}/>
          <AntDesign color={'white'} size={20} name="right" style = {{opacity: 0.1}}/>
          </View>
        </LinearGradient>
      </View>
    </View>
